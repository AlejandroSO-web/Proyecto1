     ...
     <div class="container">
         ...
         <div class="collapse navbar-collapse navbar-right" id="menu">
            <ul class="nav navbar-nav">
              <li class="<?= (esOpcionMenuActiva("index")? "active" : "");?> lien" ><a href="<?= (esOpcionMenuActiva("index")? "#" : "/");?>"><i class="fa fa-home sr-icons"></i> Home</a></li>
              ...
              <li class="<?= (esOpcionMenuActiva("asociado")? "active" : "");?> lien"><a href="<?= (esOpcionMenuActiva("asociado")? "#" : "/asociados.php");?>"><i class="fa-hand-o-right"></i> Asociado</a></li>
            </ul>
         </div>
     </div>
   </nav>
