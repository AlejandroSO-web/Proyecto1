...
class AsociadosController{
    ...
    public function asociado($request, $response, $args) {
    ...
    try {
      ...
      return $this->container->renderer->render($response, "asociados.view.php", compact('title', 'info', 'form', 'asociados', 'urlImagen'));
}
